# nvim-treesitter-queries-prql

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-prql/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-prql/actions/workflows/validate.yml)

Neovim tree-sitter queries for **prql**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-prql",
...
- [ ] Changes are scoped to `prql` — do not include files for other languages
